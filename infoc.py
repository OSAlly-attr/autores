...
combo1.place(x=160, y=122)
combo1.insert(0,option1[0])

label_header = tk.Label(root, text=u'アカウント範囲 (無入力: 最初・最後)', font=("Arial", "12", "bold"))
...
label_header3 = tk.Label(root, text=u'ver 2.1.1', font=("Arial", "12", "bold"))
